...
use crate::syscall::util::write_vaddr;
...
pub fn sys_linkat(old_name: *const u8, new_name: *const u8) -> isize {
    ...
    let result = ROOT_INODE.link(old_path.as_str(), new_path.as_str());
    result
}
...
pub fn sys_unlinkat(name: *const u8) -> isize {
    ...
    let result = ROOT_INODE.unlink(path.as_str());
    result
}
